...
import com.example.blogposts.fragments.main.account.AccountNavHostFragment
import com.example.blogposts.fragments.main.blog.BlogNavHostFragment
import com.example.blogposts.fragments.main.create_blog.CreateBlogNavHostFragment
...
class BottomNavController(
    ...
    private fun createNavHost(menuItemId: Int): Fragment {
        return when (menuItemId) {
            ...
            R.id.nav_account -> {
                AccountNavHostFragment.create(R.navigation.nav_graph_account)
            }

            R.id.nav_blog -> {
                BlogNavHostFragment.create(R.navigation.nav_graph_blog)
            }

            R.id.nav_create_blog -> {
                CreateBlogNavHostFragment.create(R.navigation.nav_graph_create_blog)
            }
